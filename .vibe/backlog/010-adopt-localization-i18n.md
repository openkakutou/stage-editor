...
## Notes
Also depends on `web-ui-kit` backlog item `011-i18n-core-primitive-and-locale-switcher` landing first, in addition to this repo's own `001-adopt-web-ui-kit-and-wasm-bridge-write-mode`.
