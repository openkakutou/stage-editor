/**
 * This app's own i18n setup (backlog item 010): wires the shared
 ...
 * contract. See `.vibe/decisions/008-i18n-integration-approach.md` for why
 ...
 * i18n itself. Mirrors `lifebar-editor`'s own identical `src/i18n/i18n.ts`
 * (that repo's own backlog item 009), the closest sibling app.
 */
import {
  type I18nInstance,
  type LocaleCatalogs,
...
export const NAMESPACE = "stage-editor";
 ...
 * OpenKakutou app on that origin. See `.vibe/decisions/008`.
 */
export const STORAGE_KEY = "stage-editor-locale";
