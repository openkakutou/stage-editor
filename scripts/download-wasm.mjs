...
// the WASM bridge (read AND write surface — both live in the same binary)
// with no local Go toolchain. Ported verbatim from `stage-viewer-web`'s own
// scripts/download-wasm.mjs (itself ported from character-viewer-web) —
// same shape, same exit codes, same flags, same source repo/assets. See
// .vibe/backlog/001-adopt-web-ui-kit-and-wasm-bridge-write-mode.md and
